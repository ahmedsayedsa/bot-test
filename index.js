...
  // حذف مجلد auth_info القديم لضمان تسجيل دخول جديد في كل مرة
...
  const app = express();
  
  // إضافة middleware لرصد البيانات الخام قبل parsing
...
      // تنسيق قائمة المنتجات (نفس الكود الأصلي)
      let itemsList = "";
...
  // التعامل مع الرسائل الواردة (نفس الكود الأصلي)
